...
async def entrypoint(ctx: JobContext):
    ...
    params = {
       # "waitForAgents": 2,
        # Use a dedicated environment variable so the restaurant voice agent is uniquely identifiable
        # from any other agent types running concurrently.
        "agentId": os.getenv("CORAL_RESTAURANT_VOICE_AGENT_ID", "restaurant-voice-agent"),
