...
export function RestaurantVoiceAgent() {
  const [room] = useState(
    () =>
      new Room({
        adaptiveStream: true,
  ...
  return (
    <RoomContext.Provider value={room}>
      <RestaurantAssistant onConnectButtonClicked={onConnectButtonClicked} />
    </RoomContext.Provider>
  );
}

function RestaurantAssistant(props: { onConnectButtonClicked: () => void }) {
