...
export default function InterfaceAgentPanel({
  messages,
  orderItems,
  onMessage,
  apiEndpoint,
}: InterfaceAgentPanelProps) {
    ...
    <div className="bg-card border rounded-lg p-6 flex flex-col h-full">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-semibold text-foreground">Restaurant Interface Assistant</h2>
            <p className="text-sm text-muted-foreground">Text-based agent for ordering and reservation</p>
          </div>
        </div>
        {/* Tool Status */}
